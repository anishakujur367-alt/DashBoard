    ...
    <section className="glass-panel glass-panel-glow p-6 rounded-2xl relative overflow-hidden flex flex-col justify-between h-full group hover:shadow-[0_0_24px_rgba(139,92,246,0.15)] transition-shadow duration-300">
      ...
      <div>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          >
            ...
            <div>
              ...
              <div className="text-base font-extrabold text-text-primary leading-none mt-0.5">
        ...
        <div className="mt-8 bg-slate-base/60 border border-card-border rounded-2xl p-4.5">
          ...
          <div className="h-2.5 w-full bg-slate-base rounded-full overflow-hidden border border-card-border">
            <motion.div
              initial={{ width: 0 }}
      ...
      {/* Level stats */}
      <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-card-border">
        {/* Stat Item 1 */}
